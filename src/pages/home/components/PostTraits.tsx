...
const PostTraits = ({ post }: Props) => {
  let { reply, retweet, favs, isLiked } = post;
  ...
  return (
    <Box>
      <div className="box">
        <span className="icons reply-icon" onClick={onReply}>
      ...
      <div className="box" onClick={handleClick}>
        <span className="icons">
          <svg viewBox="0 0 24 24" aria-hidden="true" className="svg favs" style={{ fill: isFavs ? "red" : ""}}>
        ...
        <span className="count">{favs}</span>
      </div>
      <div className="box">
        <span className="icons">
...
export default memo(PostTraits)
